...
> The corporation protected a secret by cusing Shamir’s Secret Sharing (a threshold cryptographic algorithm) to split an AES key into multiple shares. Only when a minimum threshold of shareholders (threshold t) collaborate can the original key be reconstructed and the vault decrypted.
>
